...
model.load_state_dict(torch.load('model/complete_tower_maskrcnn_resnet50_fpn_v2_augmented706_imgs_epochs320.pth', map_location=device))
...
def predict():
    try:
        ...
        if file and allowed_file(file.filename):
            ...
            original_img, annotated_img, dimensions, insulator_height, insulator_width, pattern_count = process_image(upload_path)
